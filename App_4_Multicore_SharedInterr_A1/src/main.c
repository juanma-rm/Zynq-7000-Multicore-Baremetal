// -------------------------------------------------------------------------
//
// Application 4. Use of ARM software generated interrupts (SGI). Core A1
//
// Core 1 sets up its timer to interrupt each half second and attends that
// interrupt by switching the LEDs state and by generating a SGI interrupt
// sent to core 0.
//
// Zybo Zynq-7010
//
...
int main()
{
	...
	if ( zynq7000BM_setup_privTimer(ZYNQ7000BM_TIMER_COUNT_1SEC/2,
...
static void TimerIntrHandler(void *CallBackRef)
{
	...
	// Interrupt core 0
	int Status = XScuGic_SoftwareIntr(&IntcHandler, SGI_INTERR_ID_0,
